...
var DimmerSwitchHandler = /** @class */ (function () {
    function DimmerSwitchHandler(hostRef) {
        registerInstance(this, hostRef);
        this.timeout = 1000;
        this.onDestroy$ = new Subject();
        this.dimmerclick = createEvent(this, "dimmerclick", 7);
    }
    DimmerSwitchHandler.prototype.componentDidLoad = function () {
        var _this = this;
        this.dimmer = timer(0, this.timeout).pipe(switchMap(function () { return fetch("http://" + _this.ip + "/api/" + _this.username + "/sensors/" + _this.sensor); }), switchMap(function (res) { return res.json(); }), share(), map(function (res) { return res.state; }), catchError(function () { return of(null); }));
        this.dimmer.pipe(pairwise(), filter(function (_a) {
            var v1 = _a[0], v2 = _a[1];
            return (v1.buttonevent % 1000 !== v2.buttonevent % 1000 || ((v1.buttonevent % 1000 === v2.buttonevent % 1000) && (v1.lastupdated !== v2.lastupdated)));
        }), tap(console.log), tap(this.dimmerclick.emit), takeUntil(this.onDestroy$)).subscribe();
    };
    DimmerSwitchHandler.prototype.componentDidUnload = function () {
        this.onDestroy$.next();
    };
